...
<div class="container mt-4 flex-grow-1">
    ...
    <!-- Filter Form -->
    <form class="row g-3 mt-3 mb-4" method="POST" action="{{ route('reports.product') }}">
        @csrf
        <div class="col-md-2">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover text-center align-middle" style="table-layout: fixed; width: 85%;">
            ...
            <tbody>
                @if (request()->filled('fromDate') || request()->filled('toDate') || request()->filled('product') || request()->filled('paymentMode'))
